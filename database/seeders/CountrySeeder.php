...
class CountrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        Country::create(['name' =>"Afghanistan", 'code' => "AF"]);
            ...
            Country::create(['name' =>"Congo, Democratic Republic of the Congo", 'code' => "CD"]);
            ...
            Country::create(['name' =>"Curacao", 'code' => "CW"]);
            ...
            Country::create(['name' =>"Saint Barthelemy", 'code' => "BL"]);
            ...
            Country::create(['name' =>"St Martin", 'code' => "SX"]);
